...
This course introduces **embedded systems** and their applications in **measurement, control, and automation**. Students will gain both **theoretical knowledge** and **practical programming skills** in **Embedded C programming** and **firmware development**, with an emphasis on real-world implementation.

The course is delivered using a **hybrid learning format**, combining **onsite** and **online** instruction. Each session includes **lectures** alongside **hands-on programming activities** using **16-bit Microchip microcontrollers** and development boards.
